...
WHERE 1 = 1
  ...
  AND po.pay_type = 1
  AND po.create_time >= '2020-01-06 00:00:00'
  AND '2020-01-12 23:59:59' >= po.create_time
...
where 1 = 1
  AND psro.return_date >= '2020-01-01 00:00:00'
  AND '2020-01-15 23:59:59' >= psro.return_date;
```
