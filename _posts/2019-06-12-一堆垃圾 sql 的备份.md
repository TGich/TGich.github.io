...
from
  ...
  inner join (
    ...
    group by
      pcu.wx_uid
  ) b on day(po.create_time) = b.dtime
  and b.wx_uid = po.wx_uid
where
  is_offline = 1
  and price > 199
union all
...
from
  p_order po2
  left join p_union_user puu on puu.wx_uid = po2.wx_uid
  left join p_store ps on ps.store_no = po2.store_no
where
  po2.wx_uid in (
    '12F1B89976A0DAA4BA42A0D4A6FCE8DF',
    '2CB680F5DC4EEBAC337A2D61574BB386',
    '47CA48D261141245DF1BBFAA70E4E1E3',
    '57DCE740BE615CA96812FEC4CDC85156',
    '5B88FDEC85EC55920D64CAA7F5267BBB',
    '633E03C6E35FA2C7D80BE51737EF52BC',
    '63D59FD0F5EB91E46BB897E8E8D9F230',
    '6F8E7E14369313362606561824B24AD0',
    '74098AB32A57DE2B1076163F8C1D2792',
    '84FA0D2171EF68D8A16FAE8A2FD23D2F',
    '92D41A4FD0F7EEF896109A1D6E7F2575',
    '9911475F2C1F4E5EB32792424A2273DE',
    'AF934113E7586C35E5E6F3BD878AF995',
    'C319119DD3FD9A82310D969291E85A77',
    'cf561123-d31d-4038-aa7e-62de990ae3e5',
    'D4A7CE1092EA9890C813F20AAD135915',
    'e5ef7204-806b-4d3d-9fbc-b7c680097c87',
    'EB83DAAC96E4A3B28A52A853CBCDB6C5',
    'EF4FE897AA751827532069778F3BDFE9'
  )
  and order_status = 'C'
  and price > 199
  and po2.create_time > '2019-08-02 01:09:53'
group by
  po2.wx_uid;
```
